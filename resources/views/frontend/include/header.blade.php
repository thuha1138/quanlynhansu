    ...
    <div class="navbar-custom navbar navbar-expand-lg">
        <div class="container-fluid px-0">
            <a class="navbar-brand d-block d-md-none" href="../index.html">
                <img style="width: 25%;" src="../assets/images/brand/logo/logo.png" alt="Image">
            </a>
        ...
        <div class="navbar-horizontal nav-dashboard">
            <div class="container-fluid ">
                ...
                <nav class="navbar navbar-expand-lg navbar-default navbar-dropdown p-0 py-lg-2">
                    <div
                        class="d-flex d-lg-block justify-content-between align-items-center w-100 w-lg-0 py-2  px-4 px-md-2 px-lg-0">
                    ...
                    <div class="collapse navbar-collapse  px-6 px-lg-0" id="navbar-default">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarApps">
                                    <li>
                                        ...
                                        $id = session('user_id');
                                        @endphp
                                        <a class="dropdown-item" href="{{ route('chamcong',['id'=>$id]) }}">
                                            Danh sách chấm công
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarApps">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('ticket',['id'=>$id]) }}">
                                            Danh sách Ticket
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item dropdown aaa">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" aria-labelledby="layoutsDropdown">
                                    ...
                                    <li class="nav-item">
                                        <a class="dropdown-item" href="index.html">Dự án của bạn</a>
                                    </li>
